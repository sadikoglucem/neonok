...
fetch("https://iomeu-casino-client.api.relaxg.com/game/play", {
  ...
  "body": "{\"g\":\"blackjackneo\",\"sid\":\""+sid+"\",\"restoreState\":\"{}\",\"restoreVersion\":2000,\"ga\":\"deal\",\"ba\":\"[0,200,0]\"}",
  "method": "POST",
  "mode": "cors",
  "credentials": "omit"
...
fetch("https://iomeu-casino-client.api.relaxg.com/capi/2.0/casino/token/gettoken", {
  ...
  "body": "{\"gameref\":\"blackjackneo\",\"ticket\":\"EE8A250C1E447A368A02BA8C64C31D5D5414ABC0\",\"partnerid\":\"892\",\"mode\":\"dev\",\"channel\":\"web\",\"clientid\":\"\",\"clientversion\":\"2023-08-24 1.8.0\"}",
  "method": "POST"
}).then(r => r.json()).then(r => {
...
deal();
//Keep in mind that ticket in the 'gettoken' fetch is the one that chooses currencies. This is for only nok.
});
});
};